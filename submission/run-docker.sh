...
DOCKER_TAG="localhost_${DOCKER_UNAME}"
DOCKER_INST_NAME="localhost_${DOCKER_UNAME}"
...
DOCKER_EXEC+="-v $SCRIPTPATH:/workspace/submission "
...
gecho "Mounting $SCRIPTPATH at /workspace/submission"
